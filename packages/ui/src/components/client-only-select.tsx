...
interface ClientOnlySelectProps extends Omit<React.ComponentProps<typeof SelectPrimitive.Root>, "children"> {
...
const ClientOnlySelect = ({ value, options, size = "default", placeholder, loadingPlaceholder, side = "top", id, ...props }: ClientOnlySelectProps) => {
  ...
  if (!isMounted) return <LoadingComponent loadingPlaceholder={loadingPlaceholder} />
